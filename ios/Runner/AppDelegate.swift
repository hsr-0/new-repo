...
import Flutter
import Firebase
import FirebaseMessaging // ✅ إضافة مهمة لمعالجة إشعارات FCM
import PushKit
...
@objc class AppDelegate: FlutterAppDelegate {
    ...
    // ✅ السماح لـ FCM بمعالجة الإشعارات العادية في الخلفية بشكل صحيح
    override func application(
        _ application: UIApplication,
...
// =======================================================================
// VoIP Push Registry Delegate - نظام الاتصال واستلام الإشعارات (النسخة القياسية والآمنة)
// =======================================================================
extension AppDelegate: PKPushRegistryDelegate {
    ...
    func pushRegistry(_ registry: PKPushRegistry, didReceiveIncomingPushWith payload: PKPushPayload, for type: PKPushType, withCompletionHandler completion: @escaping () -> Void) {
        ...
        // 🔥 الحل الجذري والثابت: تحويل القاموس صراحةً إلى NSDictionary لتتوافق مع المكتبة
        ...
        // ✅ عرض المكالمة فوراً عبر واجهة النظام (Native)
        ...
        // ✅ إبلاغ آبل بانتهاء المعالجة فوراً (هذا هو السبب في عدم حدوث كراش الآن)
        completion()
    }
