                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'k94erxx1' /* Let’s Create your account */,
                            ),
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'xtaqdl4z' /* Enter confirm Password */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                _model.isCheck = !(_model.isCheck ?? true);
                                safeSetState(() {});
                              },
                              child: Container(
                                decoration: BoxDecoration(),
                              ...
                              if (_model.isCheck!) {
                                if (FFAppState().connected) {
                                  ...
                                  if (PlantShopGroup.signUpCall.status(
                                    ...
                                    if (PlantShopGroup.logInCall.status(
                                      ...
                                      _model.customerData = await PlantShopGroup
                                          .getCustomerCall
                                          .call(
                                        userId: _model.id,
                                      );
                                      ...
                                      if (PlantShopGroup.getCustomerCall.status(
                                          ...
                                          null) {
                                        await actions.showCustomToastTop(
                                          PlantShopGroup.getCustomerCall
                                              .message(
                                            (_model.customerData?.jsonBody ??
                                                ''),
                                          )!,
                                        ...
                                        FFAppState().userDetail = PlantShopGroup
                                            .getCustomerCall
                                            .userDetail(
                                          (_model.customerData?.jsonBody ?? ''),
                                        );
                                ...
                                await actions.showCustomToastTop(
                                  FFLocalizations.of(context).getVariableText(
                                    ...
                                    arText: 'يرجى قبول الشروط وسياسة الخصوصية',
                                  ),
                                );
                              }
                            } else {
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: FFLocalizations.of(context).getText(
                              'p0oybniu' /* Already have a account?  */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
