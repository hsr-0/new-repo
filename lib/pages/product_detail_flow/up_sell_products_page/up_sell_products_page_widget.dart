...
import 'up_sell_products_page_model.dart';
export 'up_sell_products_page_model.dart';

class UpSellProductsPageWidget extends StatefulWidget {
  const UpSellProductsPageWidget({
    super.key,
    required this.upSellProductList,
  });

  final List<String>? upSellProductList;

  static String routeName = 'UpSellProductsPage';
  static String routePath = '/upSellProductsPage';

  @override
  State<UpSellProductsPageWidget> createState() =>
      _UpSellProductsPageWidgetState();
}

class _UpSellProductsPageWidgetState extends State<UpSellProductsPageWidget>
    with TickerProviderStateMixin, RouteAware {
  late UpSellProductsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpSellProductsPageModel());
                          ...
                          builder: (context) {
                            if (FFAppState().response) {
                              return Padding(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final upSellProductList =
                                        widget!.upSellProductList!.toList();
                                    ...
                                    return GridView.builder(
                                      ...
                                      itemCount: upSellProductList.length,
                                      itemBuilder:
                                          (context, upSellProductListIndex) {
                                        final upSellProductListItem =
                                            upSellProductList[
                                                upSellProductListIndex];
                                        return Padding(
                                          padding: EdgeInsets.all(6.0),
                                          child: FutureBuilder<ApiCallResponse>(
                                            future: FFAppState().productDdetail(
                                              uniqueQueryKey:
                                                  upSellProductListItem,
