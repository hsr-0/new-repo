...
import 'related_products_page_model.dart';
export 'related_products_page_model.dart';

class RelatedProductsPageWidget extends StatefulWidget {
  const RelatedProductsPageWidget({
    super.key,
    required this.relatedProductList,
  });

  final List<String>? relatedProductList;

  static String routeName = 'RelatedProductsPage';
  static String routePath = '/relatedProductsPage';

  @override
  State<RelatedProductsPageWidget> createState() =>
      _RelatedProductsPageWidgetState();
}

class _RelatedProductsPageWidgetState extends State<RelatedProductsPageWidget>
    with TickerProviderStateMixin, RouteAware {
  late RelatedProductsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RelatedProductsPageModel());
                          ...
                          builder: (context) {
                            if (FFAppState().response) {
                              return Padding(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final relatedProductList =
                                        widget!.relatedProductList!.toList();
                                    ...
                                    return GridView.builder(
                                      ...
                                      itemBuilder:
                                          (context, relatedProductListIndex) {
                                        final relatedProductListItem =
                                            relatedProductList[
                                                relatedProductListIndex];
                                        return Padding(
