...
import 'trending_products_page_model.dart';
export 'trending_products_page_model.dart';

class TrendingProductsPageWidget extends StatefulWidget {
  const TrendingProductsPageWidget({super.key});

  static String routeName = 'TrendingProductsPage';
  static String routePath = '/trendingProductsPage';

  @override
  State<TrendingProductsPageWidget> createState() =>
      _TrendingProductsPageWidgetState();
}

class _TrendingProductsPageWidgetState extends State<TrendingProductsPageWidget>
    with TickerProviderStateMixin, RouteAware {
  late TrendingProductsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrendingProductsPageModel());
                            ...
                            if (FFAppState().response) {
                              return Padding(
                                ...
                                child: RefreshIndicator(
                                  key: Key('RefreshIndicator_izj7kr3q'),
                                  ...
                                  child:
                                    ...
                                    builderDelegate:
                                      ...
                                      itemBuilder: (context, _,
                                        ...
                                        final trendingProductsListItem = _model
                                                .gridViewPagingController!
                                                .itemList![
                                            trendingProductsListIndex];
                                        return Padding(
