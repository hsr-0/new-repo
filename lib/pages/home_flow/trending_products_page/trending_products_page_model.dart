...
import '/index.dart';
import 'dart:async';
import 'trending_products_page_widget.dart' show TrendingProductsPageWidget;
...
class TrendingProductsPageModel
    extends FlutterFlowModel<TrendingProductsPageWidget> {
  ...
  PagingController<ApiPagingParams, dynamic> _createGridViewController(
    ...
    return controller..addPageRequestListener(gridViewTrendingProductsPage);
  }

  void gridViewTrendingProductsPage(ApiPagingParams nextPageMarker) =>
      gridViewApiCall!(nextPageMarker).then((gridViewTrendingProductsResponse) {
        final pageItems =
            (PlantShopGroup.trendingProductsCall.trendingProductsList(
                      gridViewTrendingProductsResponse.jsonBody,
                    )! ??
                    [])
                .toList() as List;
        ...
        gridViewPagingController?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: gridViewTrendingProductsResponse,
                )
              : null,
        );
      });
