...
import '/index.dart';
import 'dart:async';
import 'popular_products_page_widget.dart' show PopularProductsPageWidget;
...
class PopularProductsPageModel
    extends FlutterFlowModel<PopularProductsPageWidget> {
  ...
  PagingController<ApiPagingParams, dynamic> _createGridViewController(
    ...
    return controller..addPageRequestListener(gridViewPopularProductsPage);
  }

  void gridViewPopularProductsPage(ApiPagingParams nextPageMarker) =>
      gridViewApiCall!(nextPageMarker).then((gridViewPopularProductsResponse) {
        final pageItems =
            (PlantShopGroup.popularProductsCall.popularProductsList(
                      gridViewPopularProductsResponse.jsonBody,
                    )! ??
                    [])
                .toList() as List;
        ...
        gridViewPagingController?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: gridViewPopularProductsResponse,
                )
              : null,
        );
      });
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        localStates: {
          'filter': debugSerializeParam(
            ...
            searchReference:
                'reference=QhsKDwoGZmlsdGVyEgVldTIzcCoCEgByBAgDIAFQAVoGZmlsdGVyYhNQb3B1bGFyUHJvZHVjdHNQYWdl',
            name: 'String',
            nullable: false,
          )
        },
        ...
        link:
            'https://app.flutterflow.io/project/plant-shop-brdbek/tab=uiBuilder&page=PopularProductsPage',
        searchReference:
            'reference=OhNQb3B1bGFyUHJvZHVjdHNQYWdlUAFaE1BvcHVsYXJQcm9kdWN0c1BhZ2U=',
        widgetClassName: 'PopularProductsPage',
      );
}
