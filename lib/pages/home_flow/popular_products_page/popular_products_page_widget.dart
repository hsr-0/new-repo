...
import 'popular_products_page_model.dart';
export 'popular_products_page_model.dart';

class PopularProductsPageWidget extends StatefulWidget {
  const PopularProductsPageWidget({super.key});

  static String routeName = 'PopularProductsPage';
  static String routePath = '/popularProductsPage';

  @override
  State<PopularProductsPageWidget> createState() =>
      _PopularProductsPageWidgetState();
}

class _PopularProductsPageWidgetState extends State<PopularProductsPageWidget>
    with TickerProviderStateMixin, RouteAware {
  late PopularProductsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopularProductsPageModel());
                            ...
                            if (FFAppState().response) {
                              return Padding(
                                ...
                                child: RefreshIndicator(
                                  key: Key('RefreshIndicator_w9rqmvqy'),
                                  ...
                                  child:
                                    ...
                                    builderDelegate:
                                      ...
                                      itemBuilder: (context, _,
                                          bigSavingsProductsListIndex) {
                                        final bigSavingsProductsListItem =
