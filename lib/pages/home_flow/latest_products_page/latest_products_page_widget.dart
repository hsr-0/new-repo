...
import 'latest_products_page_model.dart';
export 'latest_products_page_model.dart';

class LatestProductsPageWidget extends StatefulWidget {
  const LatestProductsPageWidget({super.key});

  static String routeName = 'LatestProductsPage';
  static String routePath = '/latestProductsPage';

  @override
  State<LatestProductsPageWidget> createState() =>
      _LatestProductsPageWidgetState();
}

class _LatestProductsPageWidgetState extends State<LatestProductsPageWidget>
    with TickerProviderStateMixin, RouteAware {
  late LatestProductsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LatestProductsPageModel());
                            ...
                            if (FFAppState().response) {
                              return Padding(
                                ...
                                child: RefreshIndicator(
                                  key: Key('RefreshIndicator_yqgk830m'),
                                  ...
                                  child:
                                    ...
                                    builderDelegate:
                                      ...
                                      itemBuilder: (context, _,
                                        ...
                                        final latestProductsListItem = _model
                                            .gridViewPagingController!
                                            .itemList![latestProductsListIndex];
                                        return Padding(
