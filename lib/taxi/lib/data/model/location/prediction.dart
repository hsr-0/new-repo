...
class Prediction {
  ...
  List<Terms>? terms;
  List<String>? types;
  // 🟢 التعديل: تغيير النوع من String إلى double ليتوافق مع أرقام الخريطة والسيرفر
  double? lat;
  double? lng;
  ...
  Prediction.fromJson(Map<String, dynamic> json) {
    ...
    // 🟢 التعديل الحاسم: تحويل البيانات القادمة من السيرفر إلى أرقام عشرية بأمان
    // هذا الجزء هو الذي يحل خطأ 500 في التطبيق
