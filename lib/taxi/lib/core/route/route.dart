import 'package:cosmetic_store/taxi/lib/presentation/screens/Profile/profile_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/account/change-password/change_password_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/auth/email_verification_page/email_verification_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/auth/forget_password/forget_password/forget_password.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/auth/forget_password/reset_password/reset_password_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/auth/forget_password/verify_forget_password/verify_forget_password_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/auth/login/login_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/auth/profile_complete/profile_complete_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/auth/registration/registration_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/auth/sms_verification_page/sms_verification_screen.dart';
import 'package:cosmetic_store/taxi/lib/presentation/screens/dashboard/dashboard_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/edit_profile/edit_profile_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/faq/faq_screen.dart';
import 'package:cosmetic_store/taxi/lib/presentation/screens/image_preview/preview_image_screen.dart';
import 'package:cosmetic_store/taxi/lib/presentation/screens/inbox/ride_message_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/language/language_screen.dart';
import 'package:cosmetic_store/taxi/lib/presentation/screens/location/screen/locationpicker/location_edit_screen.dart';
import 'package:cosmetic_store/taxi/lib/presentation/screens/location/screen/locationpicker/location_picker_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/maintenance/maintanance_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/onbaord/onboard_intro_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/coupon/coupon_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/payment/payment_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/privacy_policy/privacy_policy_screen.dart';
import 'package:cosmetic_store/taxi/lib/presentation/screens/profile_and_settings/profile_and_settings_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/review/driver_review_history_screen.dart';
import 'package:cosmetic_store/taxi/lib/presentation/screens/review/ride_review_screen.dart';
import 'package:cosmetic_store/taxi/lib/presentation/screens/review/my_review_history_screen.dart';
import 'package:cosmetic_store/taxi/lib/presentation/screens/ride/ride_details_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/ride/ride_activity_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/ride_bid_list/ride_bid_list_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/splash/splash_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/support_ticket/new_ticket_screen/add_new_ticket_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/support_ticket/support_ticket_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/support_ticket/ticket_details/ticket_details_screen.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/payment_history/payments_history_screen.dart';

import 'package:get/get.dart';

import 'package:cosmetic_store/taxi/lib/presentation/screens/web_view/web_view_screen.dart';
